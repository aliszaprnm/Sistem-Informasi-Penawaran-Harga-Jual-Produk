    ...
    <div class="card-body">
      <form action="" method="post">
        <div class="form-group">
          ...
          <input type="text" name="kode_customer" readonly class="form-control form-control-sm" id="kode_customer" value="<?php echo $row->kode_customer ?>">
        </div>
        <div class="form-group">
          <label for="nama_customer">Nama Customer</label>
          <input type="text" name="nama_customer" class="form-control form-control-sm" id="nama_customer" value="<?php echo $row->nama_customer ?>">
          <?php echo form_error('nama_customer', '<span class="text-danger small pl-3">', '</span>'); ?>
        </div>
        <div class="form-group">
          <label for="alamat">Alamat</label>
          <input type="text" name="alamat" class="form-control form-control-sm" id="alamat" value="<?php echo $row->alamat ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" name="telp" class="form-control form-control-sm" id="telp" value="<?php echo $row->telp ?>">
