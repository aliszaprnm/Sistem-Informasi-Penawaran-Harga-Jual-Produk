    ...
    <div class="card-body">
      <form action="" method="post">
        ...
        <div class="form-group">
          ...
          <input type="number" lang="en" step="0.001" name="lebar" class="form-control form-control-sm" id="lebar" value="<?php echo set_value('lebar') ?>">
          <?php echo form_error('lebar', '<span class="text-danger small pl-3">', '</span>'); ?>
        </div>
        <div class="form-group">
          <label for="panjang">Panjang Material</label>
          <input type="number" lang="en" step="0.001" name="panjang" class="form-control form-control-sm" id="panjang" value="<?php echo set_value('panjang') ?>">
          <?php echo form_error('panjang', '<span class="text-danger small pl-3">', '</span>'); ?>
        </div>
        <div class="form-group">
          <label for="harga">Harga Material</label>
          <input type="number" name="harga" class="form-control form-control-sm" id="harga" value="<?php echo set_value('harga') ?>">
