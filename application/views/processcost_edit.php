    ...
    <div class="card-body">
      <form action="" method="post">
        ...
        <div class="form-group">
          ...
          <input type="number" min="0" lang="en" step="0.01" name="packing" class="form-control form-control-sm" id="packing" value="<?php echo $row->harga_packing ?>">
          <?php echo form_error('packing', '<span class="text-danger small pl-3">', '</span>'); ?>
        </div>
        <div class="form-group">
          <label for="quality">Quality Control</label>
          <input type="number" min="0" lang="en" step="0.01" name="quality" class="form-control form-control-sm" id="quality" value="<?php echo $row->harga_qc ?>">
          <?php echo form_error('quality', '<span class="text-danger small pl-3">', '</span>'); ?>
        </div>
        <div class="form-group">
          <label for="mtc_dies">Maintenance Dies</label>
          <input type="number" min="0" lang="en" step="0.01" name="mtc_dies" class="form-control form-control-sm" id="mtc_dies" value="<?php echo $row->harga_mtc_dies ?>">
          <?php echo form_error('mtc_dies', '<span class="text-danger small pl-3">', '</span>'); ?>
        </div>
        <div class="form-group">
          <label for="harga_material">Profit & OH</label>
          <input type="number" min="0" lang="en" step="0.01" name="profit_oh" class="form-control form-control-sm" id="profit_oh" value="<?php echo $row->profit_dan_OH ?>">
