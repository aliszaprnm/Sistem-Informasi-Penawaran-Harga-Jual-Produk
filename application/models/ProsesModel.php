...
class ProsesModel extends CI_Model
{
	...
	public function GetProsesProduk($where=array())
	{
		$this->db->select('*, proses_produk.id, produk.kode_produk as kode, produk.nama_produk as nama_produk, mesin.nama_mesin as nama_mesin, mesin.kekuatan as kekuatan, proses.harga as harga_proses');
		// $this->db->select('*');
